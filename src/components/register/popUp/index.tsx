...
interface PropsErrorPopUp {
  onClose: () => void;
  children: ReactNode;
}

export const ErrorPopUp: FC<PropsErrorPopUp> = ({ onClose, children }) => {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        ...
        >
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all xl:w-[472px] w-[336px] px-[20px] py-[20px] flex flex-col gap-[20px] items-center justify-center">
