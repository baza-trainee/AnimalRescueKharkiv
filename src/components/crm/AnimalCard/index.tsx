    ...
    <div className="conteiner">
      <div className="w-[342px] mx-6 pb-20">
        <header className="h-14 border-b border-lightBlue flex justify-between pt-5 pb-1 mb-6">
          <button onClick={() => router.back()}><ICONS.COMEBACK_BTN/></button>
          <div><ICONS.UPLOAD_BTN/></div>
        </header>
        <div className="flex justify-between">
        <div className="flex flex-col gap-1">
          <div className="font-bold text-[32px] leading-[48px] text-crm-black">{animal.name} </div>
            <div className="font-normal text-xl leading-[28px] text-crm-secondary-blue">ID{animal.id}</div>
        </div>
