      ...
      <nav className="px-0 py-2">
        <ul className='flex flex-row px-4'>
          <li className="w-20 flex justify-center"> 
            <Link href="/crm" className={`flex flex-col items-center ${
              isActive('/crm') ? 'text-mainBlue fill-mainBlue  text-opacity-100' : ' text-mainBlue text-opacity-40 '
              } `} >              
          ...
          <li className="w-20 flex justify-center">
            <Link href="/crm/add-card" className={`flex flex-col items-center ${
              isActive('/crm/add-card') ? 'text-mainBlue fill-mainBlue  text-opacity-100' : ' text-mainBlue text-opacity-40 '
              } `}>
          ...
          <li className="w-20 flex justify-center">
            <Link href="/crm/catalog" className={`flex flex-col items-center ${
              isActive('/crm/catalog') ? 'text-mainBlue fill-mainBlue  text-opacity-100' : ' text-mainBlue text-opacity-40 '
              } `}>
          ...
          <li className="w-20 flex justify-center">
            <Link href="/crm/profile"  className={`flex flex-col items-center ${
              isActive('/crm/profile') ? 'text-mainBlue fill-mainBlue  text-opacity-100' : ' text-mainBlue text-opacity-40 '
              } `}>
